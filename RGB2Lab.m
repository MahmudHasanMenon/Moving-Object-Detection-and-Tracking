...
%                  This defaults to 'D65' which corresponds to a typical monitor.
%
...
% transformed image can have the proper negative values for a and b.  (If the
% image is left as uint8 MATLAB will shift the values into the range 0-255)
%
